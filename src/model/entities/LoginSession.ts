...
import GraphService from "@entity-access/server-pages/dist/services/GraphService.js";
...
export default class LoginSession {
    ...
    [GraphService.appendToGraph]() {
        delete this.deviceToken;
        delete this.deviceTokenType;
        return {
            deviceToken: "",
            deviceTokenType: ""
        };
